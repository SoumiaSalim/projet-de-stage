<div class="left-sidebar">
            ...
            <div class="brand">
                <a href="index.html" class="logo">
                    ...
                    <span>
                        <img src="{{asset('assets/images/users/favicon.PNG')}}" alt="logo-large" class="logo-lg logo-light">
            ...
            <div class="sidebar-user-pro media border-end">                    
                <div class="position-relative mx-auto">
                    <img src="{{asset('assets/images/users/favicon.PNG')}}" alt="user" class="rounded-circle thumb-md">
                        ...
                        <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarAnalytics">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url('patient/create')}}" class="nav-link ">Nouveaux patients</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a href="{{ url('patient/all')}}" class="nav-link ">Tous les patients</a>
                                        </li><!--end nav-item-->
                                    </ul><!--end nav-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarCrypto">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('appointment/create')}}">Nouveaux Rendez-vous</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('appointment/pending')}}">En attente de Rendez-vous</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('appointment/all')}}">Tous les Rendez-vous</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarProjects">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('prescription/create')}}">Nouveaux Ordonnances</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('prescription/all')}}">Tous les Ordonnances</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarEcommerce">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('drug/create')}}">Ajouter un médicaments</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('drug/all')}}">Tous les médicaments</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarEmail">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('test/create')}}">Ajouter de nouveaux tests</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('test/all')}}">Tous les tests de diagnostic</a>
                                        </li><!--end nav-item--> 
                                    </ul><!--end nav-->
                            ...
                            <a class="nav-link" href="#sidebarEmail" data-bs-toggle="collapse" role="button"
                                ...
                                <div class="collapse " id="sidebarEmail">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('billing/create')}}">Créer une facture</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('billing/all')}}">Liste de paiement</a>
                                        </li><!--end nav-item--> 
                                    </ul><!--end nav-->
                                </div><!--end sidebarEmail-->
                            </li><!--end nav-item-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarForms">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('settings/doctorino_settings')}}">Paramètres du médecin</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('settings/prescription_settings')}}">Paramètres d'ordonnance</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('settings/sms_settings')}}">Configuration de la passerelle SMS</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
