         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <div class="form-group">
                  <label for="drug">Sélectionnez un patient...</label>
               ...
               <div class="form-group">
                  <label for="DueAmount">Montant dû</label>
                  <input class="form-control" type="number" name="due_amount" id="DueAmount">
               </div>


               <div class="form-group">
                  <label for="PaymentMode">Statut de paiement</label>
               ...
               <div class="form-group">
                  <input type="submit" value="<?php echo e(__('Créer une facture')); ?>" class="btn btn-warning btn-block" align="center">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <fieldset class="billing_labels">
                  ...
                  <div class="form-group">
                     <a type="button" class="btn btn-primary btn-sm add text-white" align="center"><i class='fa fa-plus'></i> Ajouter un item</a>
                  </div>
               </fieldset>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doc\doctorino\resources\views/billing/create.blade.php ENDPATH**/ ?>