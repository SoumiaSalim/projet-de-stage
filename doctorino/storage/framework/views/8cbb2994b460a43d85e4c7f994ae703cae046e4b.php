               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     <select class="form-control" name="language" id="Language" required>
                        <option value="<?php echo e(App\Setting::get_option('language')); ?>">Anglais</option>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     <select class="form-control" name="appointment_interval" id="appointment_interval" required>
                        <option value="<?php echo e(App\Setting::get_option('appointment_interval')); ?>"><?php echo e(App\Setting::get_option('appointment_interval')); ?> min</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp1\htdocs\doc\doctorino\resources\views/settings/doctorino_settings.blade.php ENDPATH**/ ?>