...
class AppointmentController extends Controller
{
	...
	public function store(Request $request){
		...
		return Redirect()->back()::route('appointment.all')->with('success', 'Appointment Created Successfully!');
    ...
    public function store_edit(Request $request){
        ...
        return Redirect()->back()::back()->with('success', 'Appointment Updated Successfully!');
    }
    ...
    public function destroy($id){
        ...
        return Redirect()->back()::route('appointment.all')->with('success', 'Appointment Deleted Successfully!');
