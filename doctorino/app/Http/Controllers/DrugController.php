...
class DrugController extends Controller{
    ...
    public function store(Request $request){
    	...
    	return Redirect()->back()::route('drug.all')->with('success', __('sentence.Drug added Successfully'));
    }
    ...
    public function store_edit(Request $request){
        ...
        return Redirect()->back()::route('drug.all')->with('success', __('sentence.Drug Edited Successfully'));
        ...
        Drug::destroy($id);
        return Redirect()->back()::route('drug.all')->with('success', __('sentence.Drug Deleted Successfully'));
