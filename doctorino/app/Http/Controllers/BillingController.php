...
class BillingController extends Controller
{
    ...
    public function store(Request $request){
		...
		return Redirect()->back()::route('billing.all')->with('success', 'Invoice Created Successfully!');;
    ...
    public function update(Request $request){
       ...
       // return $request;
        ...
        return Redirect()->back()::route('billing.all')->with('success', 'Invoice Edited Successfully!');;
    ...
    public function destroy($id){
        ...
        Billing::destroy($id);
        return Redirect()->back()::route('billing.all')->with('success', 'Invoice Deleted Successfully!');
