...
class SettingController extends Controller
{
    ...
    public function doctorino_settings_store(Request $request){
    	...
    	return Redirect()->back()::route('doctorino_settings.edit')->with('success', __("sentence.Settings edited Successfully") );
    }
    ...
    public function prescription_settings_store(Request $request){
        ...
        return Redirect()->back()::route('prescription_settings.edit')->with('success', __("sentence.Settings edited Successfully"));
    ...
    public function sms_settings_store(Request $request){
        ...
        return Redirect()->back()::route('sms_settings.edit')->with('success', __("sentence.Settings edited Successfully"));
